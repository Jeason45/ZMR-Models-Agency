      ...
      return (
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '8px' }}>
            <h5 style={{ fontSize: '14px', fontWeight: 600, color: 'white', margin: 0 }}>{label}</h5>
            {files.length > 0 && (
              <span style={{ fontSize: '12px', color: 'rgba(255, 255, 255, 0.5)' }}>({files.length} fichiers)</span>
            )}
          </div>
          <p style={{ fontSize: '12px', color: 'rgba(255, 255, 255, 0.5)', marginBottom: '12px' }}>{description}</p>
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
        ...
        <div style={{
          ...
          <h4 style={{ fontSize: '15px', fontWeight: 600, color: 'white', marginBottom: '16px' }}>
            Galerie Générale
          </h4>
          <GalleryUploader
        ...
        {allGalleries.map(({ type, galleries }) => (
          <div key={type} style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
              ...
              <h4 style={{ fontSize: '14px', fontWeight: 500, color: 'rgba(255, 255, 255, 0.7)', margin: 0 }}>
        ...
        {formData.types.includes('ACTING') && (
          <div style={{
            ...
            <h4 style={{ fontSize: '15px', fontWeight: 600, color: '#f59e0b', marginBottom: '16px' }}>
        ...
        {hasActing && (
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
              ...
              <h4 style={{ fontSize: '15px', fontWeight: 600, color: 'white', margin: 0 }}>Credits</h4>
            </div>
            ...
            <div>
              ...
              <p style={{ fontSize: '12px', color: 'rgba(255, 255, 255, 0.5)', marginBottom: '12px' }}>Films, séries, théâtre, publicités...</p>

              {formData.credits.length > 0 && (
                <div style={{ marginBottom: '12px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
                  {formData.credits.map((credit, index) => (
                    <div key={index} style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '10px 12px', backgroundColor: 'rgba(255, 255, 255, 0.05)', borderRadius: '6px', border: '1px solid rgba(255, 255, 255, 0.15)' }}>
                      <div style={{ flex: 1 }}>
                        <p style={{ fontSize: '13px', fontWeight: 500, color: 'white' }}>{credit.title}</p>
                        <p style={{ fontSize: '12px', color: 'rgba(255, 255, 255, 0.5)' }}>{credit.role} • {credit.year} • {credit.type}</p>
                      </div>
              ...
              <button
                ...
                style={{ width: '100%', padding: '10px', backgroundColor: 'rgba(255, 255, 255, 0.05)', border: '1px dashed rgba(255, 255, 255, 0.2)', borderRadius: '6px', fontSize: '13px', fontWeight: 500, color: 'rgba(255, 255, 255, 0.7)', cursor: 'pointer' }}
              >
                + Ajouter un crédit
              </button>
            </div>
        ...
        {hasPromo && (
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
              ...
              <h4 style={{ fontSize: '15px', fontWeight: 600, color: 'white', margin: 0 }}>Collaborations & Events</h4>
            </div>
              ...
              {formData.collaborations.length > 0 && (
                <div style={{ marginBottom: '12px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
                  {formData.collaborations.map((collab, index) => (
                    <div key={index} style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '10px 12px', backgroundColor: 'rgba(255, 255, 255, 0.05)', borderRadius: '6px', border: '1px solid rgba(255, 255, 255, 0.15)' }}>
                      <div style={{ flex: 1 }}>
                        <p style={{ fontSize: '13px', fontWeight: 500, color: 'white' }}>{collab.brandName}</p>
                        {(collab.year || collab.type) && <p style={{ fontSize: '12px', color: 'rgba(255, 255, 255, 0.5)' }}>{[collab.year, collab.type].filter(Boolean).join(' • ')}</p>}
                      </div>
            ...
            <div style={{ marginTop: '20px' }}>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
                {['Fashion Events', 'Brand Activation', 'Hostessing', 'Trade Shows', 'Product Launch', 'Luxury Events', 'Lifestyle'].map(cat => (
                  <label key={cat} style={{ display: 'flex', alignItems: 'center', gap: '6px', padding: '6px 12px', backgroundColor: 'rgba(255, 255, 255, 0.05)', borderRadius: '6px', border: '1px solid rgba(255, 255, 255, 0.15)', cursor: 'pointer' }}>
                    <input
                      type="checkbox"
        ...
        {hasDetails && (
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
              ...
              <h4 style={{ fontSize: '15px', fontWeight: 600, color: 'white', margin: 0 }}>Campaigns</h4>
            </div>
            ...
            <div>
              ...
              <p style={{ fontSize: '12px', color: 'rgba(255, 255, 255, 0.5)', marginBottom: '12px' }}>Marques, collaborations publicitaires...</p>
              ...
              {formData.campaigns.length > 0 && (
                <div style={{ marginBottom: '12px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
                  {formData.campaigns.map((campaign, index) => (
                    <div key={index} style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '10px 12px', backgroundColor: 'rgba(255, 255, 255, 0.05)', borderRadius: '6px', border: '1px solid rgba(255, 255, 255, 0.15)' }}>
                      <div style={{ flex: 1 }}>
                        <p style={{ fontSize: '13px', fontWeight: 500, color: 'white' }}>{campaign.brandName}</p>
                        {(campaign.year || campaign.type) && <p style={{ fontSize: '12px', color: 'rgba(255, 255, 255, 0.5)' }}>{[campaign.year, campaign.type].filter(Boolean).join(' • ')}</p>}
                      </div>
              ...
              return (
                ...
                >
                  ...
                  <div style={{ padding: '12px' }}>
                    <p style={{ fontSize: '14px', fontWeight: 600, color: 'white', margin: 0, marginBottom: '4px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                      {exp.title}
                    </p>
                  ...
                  <div style={{
                    ...
                    {index > 0 && (
                      <button
                        ...
                        style={{ padding: '4px 6px', backgroundColor: 'rgba(255, 255, 255, 0.1)', border: 'none', borderRadius: '4px', cursor: 'pointer', fontSize: '10px', color: 'rgba(255, 255, 255, 0.7)' }}
                      >
                        ←
                      </button>
                    )}
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: '12px' }}>
            ...
            {currentStep < 6 ? (
              ...
              <button
                ...
                style={{
                  padding: '12px 24px',
                  backgroundColor: loading || !formData.name || !formData.mainImage ? 'rgba(255, 255, 255, 0.2)' : '#10b981',
                  border: 'none',
                  borderRadius: '8px',
                  fontSize: '14px',
                  fontWeight: 600,
