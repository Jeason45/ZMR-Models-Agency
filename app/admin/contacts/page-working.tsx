...
interface Contact {
  ...
  phone: string | null;
  message: string | null;
  type: string | null; // "professional", "model"
...
export default function ContactsPage() {
  ...
  const filterContacts = () => {
    ...
    if (activeSection !== 'all') {
      filtered = filtered.filter(c => c.type === activeSection);
    }
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{
              ...
              {activeSection === 'professional' && ' • Professionnels'}
              {activeSection === 'model' && ' • Mannequins'}
            ...
            <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
              <button
                ...
                style={{
                  padding: '8px 16px',
                  borderRadius: '8px',
                  border: activeSection === 'all' ? '2px solid #6366f1' : '1px solid #e2e8f0',
                  backgroundColor: activeSection === 'all' ? '#eef2ff' : 'white',
                  color: activeSection === 'all' ? '#6366f1' : '#64748b',
                  fontSize: '13px',
                  fontWeight: 500,
                  cursor: 'pointer',
                  transition: 'all 0.2s'
              ...
              <button
                ...
                style={{
                  padding: '8px 16px',
                  borderRadius: '8px',
                  border: activeSection === 'professional' ? '2px solid #8b5cf6' : '1px solid #e2e8f0',
                  backgroundColor: activeSection === 'professional' ? '#ede9fe' : 'white',
                  color: activeSection === 'professional' ? '#8b5cf6' : '#64748b',
                  fontSize: '13px',
                  fontWeight: 500,
                  cursor: 'pointer',
                  transition: 'all 0.2s'
              ...
              >
                Professionnels ({contacts.filter(c => c.type === 'professional').length})
              </button>
              <button
                ...
                style={{
                  padding: '8px 16px',
                  borderRadius: '8px',
                  border: activeSection === 'model' ? '2px solid #f59e0b' : '1px solid #e2e8f0',
                  backgroundColor: activeSection === 'model' ? '#fef3c7' : 'white',
                  color: activeSection === 'model' ? '#f59e0b' : '#64748b',
                  fontSize: '13px',
                  fontWeight: 500,
                  cursor: 'pointer',
                  transition: 'all 0.2s'
              ...
              >
                Mannequins ({contacts.filter(c => c.type === 'model').length})
              </button>
            </div>
          </div>
          ...
          <div style={{
            ...
            {loading ? (
              ...
              <div style={{ padding: '40px', textAlign: 'center' }}>
                <p style={{ color: '#64748b', marginBottom: '8px' }}>Aucun lead trouvé</p>
                <p style={{ color: '#94a3b8', fontSize: '13px' }}>
                  {searchQuery || statusFilter !== 'all' ? 'Essayez de modifier vos filtres' : 'Les leads apparaîtront ici'}
                </p>
              </div>
            ) : (
              <div>
                      ...
                      {selectedContact.type && (
                        <div style={{ marginBottom: '12px' }}>
                          ...
                          <div style={{
                            ...
                            fontSize: '12px',
                            fontWeight: 500,
                            color: selectedContact.type === 'professional' ? '#8b5cf6' : '#f59e0b',
                            backgroundColor: selectedContact.type === 'professional' ? '#ede9fe' : '#fef3c7'
                          }}>
                            {selectedContact.type === 'professional' ? 'Professionnel' : 'Mannequin'}
                          </div>
                        </div>
                      )}
